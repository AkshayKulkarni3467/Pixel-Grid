...
import image1Bg from '../assets/walls/Image1_Bg.png'
import image1 from '../assets/walls/Image1.jpg'
import image2Bg from '../assets/walls/Image2_Bg.png'
import image2 from '../assets/walls/Image2.jpg'
import image3Bg from '../assets/walls/Image3_Bg.png'
import image3 from '../assets/walls/Image3.jpg'
import image4Bg from '../assets/walls/Image4_Bg.png'
      ...
      <main className='flex m-10 mt-6 p-7 pt-0 h-[600px]' id='dashboard'>
        {
          image
            ...
            <div className='h-[450px] w-[35vw] mt-24 pb-20 flex items-center justify-center absolute left-[5vw]' style={{overflow: 'hidden'}}>
              ...
              <img src={`image${i}Bg`} alt="" className='max-w-[40%] h-[500px] object-contain fixed z-10 opacity-90'/>
              i++;
              <div className="bg-yellow-300 w-[33%] fixed h-[500px] z-5 opacity-100"
              style={{
            ...
            <label htmlFor="img" className='flex-1 p-10 bottom-5 bg-slate-100 rounded-[10%] fixed'>
              <div className='flex flex-col justify-center items-center w-[35vw] h-[450px] border-[8px] border-dashed rounded-[10%]'>
                ...
                <input id='img' type="file" onChange={handleFile} className='opacity-0' />
        ...
        <button className='bg-purple-700 text-slate-50 fixed bottom-14 right-20 p-4 py-3 rounded-xl text-xl font-one drop-shadow-xl hover:bg-purple-600'>
          Generate
        </button>
      </main>
    </>
